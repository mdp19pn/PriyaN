#ifndef CELLPARTICLEADHESIONFORCE_HPP_
#define CELLPARTICLEADHESIONFORCE_HPP_
...
class CellParticleAdhesionForce : public GeneralisedLinearSpringForce<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /*CELLPARTICLEADHESIONFORCE_HPP_*/
