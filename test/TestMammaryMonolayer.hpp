...
public:
    ...
    void TestMammaryMonolayer3D()
    {
        ...
        nodes.push_back(new Node<3>(0,  false,  0.5, 0.0, 6.0));
        nodes.push_back(new Node<3>(1,  false,  0.0, 0.5, 6.0));
        nodes.push_back(new Node<3>(2,  false,  1.0, 0.0, 6.0));
        nodes.push_back(new Node<3>(3,  false,  1.0, 0.0, 5.0));
        nodes.push_back(new Node<3>(4,  false,  0.5, 1.0, 6.0));
        nodes.push_back(new Node<3>(5,  false,  1.0, 0.5, 6.0));
        nodes.push_back(new Node<3>(6,  false,  1.0, 0.5, 5.0));
